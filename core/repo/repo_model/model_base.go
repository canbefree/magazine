...
func init() {
	...
	tables["m_inventory"] = m_inventoryTableInfo
	tables["m_inventory_decr"] = m_inventory_decrTableInfo
	tables["m_inventory_incr"] = m_inventory_incrTableInfo
	tables["m_inventory_tran"] = m_inventory_tranTableInfo
}
